...
root = '/home/ubuntu/baseline/RAVDESS'
print(script_dir)
n_folds=1
...
for fold in range(n_folds):
        ...
        for parent in os.listdir(os.path.join(script_dir, root)):
            ...
            for video in os.listdir(os.path.join(script_dir, root, parent)):
                ...
                if i in train_ids:
                    with open(annotation_file, 'a') as f:
                        f.write(os.path.join(script_dir, root, parent, video) + ';' + os.path.join(script_dir, root, parent , audio) + ';' + label + ';training' + '\n')
            

                elif i in val_ids:
                    with open(annotation_file, 'a') as f:
                        f.write(os.path.join(script_dir, root, parent, video) + ';' + os.path.join(script_dir, root, parent, audio) + ';'+ label + ';validation' + '\n')
            
                else:
                    with open(annotation_file, 'a') as f:
                        f.write(os.path.join(script_dir, root, parent, video) + ';' + os.path.join(script_dir, root, parent, audio) + ';'+ label + ';testing' + '\n')
